    ...
    <div class="col-md-6">
      ...
      <form action="/addplayer" method="post">
        ...
        <div class="mb-3">
          ...
          <input type="text" name="first_name" id="first_name" value="{{ $player->first_name }}" class="form-control" required>
        ...
        <div class="mb-3">
          ...
          <input type="text" id="last_name" name="last_name" value="{{ $player->last_name }}" class="form-control" required>
        ...
        <div class="mb-3">
          ...
          <input type="number" id="salary" name="salary" step="0.01" value="{{ $player->salary }}" class="form-control" required>
