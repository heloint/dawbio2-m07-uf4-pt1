        ...
        <div class="row justify-content-center mt-5">
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="coach" name="coach" class="form-control" value="{{ $team->coach }}"
                        required>
                    @if ($errors->has('coach'))
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="category" name="category" class="form-control" value="{{ $team->category }}"
                        required>
